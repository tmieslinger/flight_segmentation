...
### circle:
- can be identified by a constant change of aircraft heading, lasting anywhere around 20 to 60 min (depending on circle radius), as well as a roughly constant roll angle of 1.5-3 degrees (positive or negative, depending on turning clockwise or counter-clockwise) for the standard circle of about 200km diameter. The smaller ATR circle has a larger roll angle of 3-5 degree depending on and varying with the wind speed and direction at the respective altitude.
